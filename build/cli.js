...
(function (EntryPoint) {
    ...
    var CliService = /** @class */ (function () {
        function CliService() {
            this._program = new commander_1.Command();
            this._program.version("0.0.3");
        }
        CliService.prototype.run = function (args) {
        ...
        CliService.prototype.printHelp = function () {
            Logger.log("\uB3C4\uC6C0\uB9D0\uC785\uB2C8\uB2E4.");
        };
        CliService.getInstance = function () {
            return CliService.INSTANCE;
        };
        CliService.INSTANCE = new CliService();
        return CliService;
    }());
    EntryPoint.CliService = CliService;
