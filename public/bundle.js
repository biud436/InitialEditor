...
const electron_1 = __webpack_require__(/*! electron */ "./node_modules/electron/index.js");
    ...
    handleRemoteCommand("REMOTE_BROWSER_GET_BUILTIN" /* BROWSER_GET_BUILTIN */, function (event, contextId, moduleName, stack) {
        ...
        if (customEvent.returnValue === undefined) {
            if (customEvent.defaultPrevented) {
                ...
                customEvent.returnValue = __webpack_require__(/*! electron */ "./node_modules/electron/index.js")[moduleName];
            }
        }
        return valueToMeta(event.sender, contextId, customEvent.returnValue);
    });
...
var mainWindow_1 = __webpack_require__(/*! ./windows/mainWindow */ "./main/windows/mainWindow.ts");
var config_1 = __webpack_require__(/*! ./config */ "./main/config/index.ts");
var splashWindow_1 = __webpack_require__(/*! ./windows/splashWindow */ "./main/windows/splashWindow.ts");
var Path_1 = __webpack_require__(/*! ./utils/Path */ "./main/utils/Path.ts");
var electron_serve_1 = __importDefault(__webpack_require__(/*! electron-serve */ "./node_modules/electron-serve/index.js"));
var remote = __webpack_require__(/*! @electron/remote/main */ "./node_modules/@electron/remote/main/index.js");
remote.initialize();
var Path = Path_1.EntryPoint.Path;
...
var EntryPoint = /** @class */ (function () {
     ...
     */
    EntryPoint.prototype.initWithTitle = function () {
        electron_1.app.setName("InitialEditor");
    };
    EntryPoint.prototype.createUserDataStorage = function () {
        if (this.isProd) {
            (0, electron_serve_1.default)({ directory: "app" });
        }
        else {
     ...
     */
    EntryPoint.prototype.printMonitorInfo = function () {
        var data = {};
    ...
    EntryPoint.prototype.connectIPC = function (hostWindow) {
        var _this = this;
        hostWindow.on("closed", function () {
            _this._hostWindow = null;
        });
        // 별도의 패턴으로 정리해야 할 필요성이 있음.
        electron_1.ipcMain.on("minimize", function () { return hostWindow.minimize(); });
        electron_1.ipcMain.on("maximize", function () { return hostWindow.onMaximize(); });
        electron_1.ipcMain.on("message_box:error", function (event) {
            var args = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                args[_i - 1] = arguments[_i];
            }
            var title = args[0], content = args[1];
            electron_1.dialog.showErrorBox(title, content);
        });
        electron_1.ipcMain.on("close", function () { return hostWindow.close(); });
        electron_1.ipcMain.on("set-resolution", function (event, width, height) {
     ...
     */
    EntryPoint.prototype.createInternalMenuForDarwin = function (hostWindow) {
     ...
     * @returns
     */
    EntryPoint.prototype.createWindow = function () {
        this.connectIPC((this._hostWindow = new mainWindow_1.MainWindow(config_1.config.mainWindow.get())));
     ...
     */
    EntryPoint.prototype.listenOn = function () {
        var _this = this;
        electron_1.app.whenReady().then(function () {
            _this.createWindow();
            if (process.platform === "darwin") {
                electron_1.ipcMain.emit("creatSystemMenu", _this._hostWindow);
            }
            // open develooper tools
            _this._hostWindow.webContents.openDevTools({
                mode: "detach",
            });
            _this._hostWindow.center();
            (0, splashWindow_1.showSplashWindow)(_this._hostWindow);
        });
...
exports.config = {
    mainWindow: {
        get: function () {
            ...
            var options = __assign(__assign({}, windowRect), { webPreferences: {
                    nodeIntegration: true,
                    contextIsolation: false,
                    devTools: true,
                    // allowRunningInsecureContent: true,
                }, show: false, frame: isMacOS ? true : false, titleBarStyle: isMacOS ? "default" : "hidden", darkTheme: true, alwaysOnTop: false });
            return options;
        },
    },
    splashWindow: {
...
(function (EntryPoint) {
    var Path = /** @class */ (function () {
        ...
        Path.join = function () {
            ...
            return url.pathToFileURL(path.join.apply(path, paths)).href;
        };
        Path.resolve = function () {
            ...
            return url.pathToFileURL(path.resolve.apply(path, paths)).href;
        };
...
var MainWindow = /** @class */ (function (_super) {
    ...
    function MainWindow(options) {
        ...
        _this.isProd = "development" === "production";
    ...
    MainWindow.prototype.setConfiguration = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.$ = this.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
                        if (!this.isProd) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.loadURL("app://./home.html")];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
                        ...
                        return [4 /*yield*/, this.loadURL("http://localhost:8080/home")];
                    case 3:
                        // await this.loadURL(`http://localhost:${port}/home`);
                        _a.sent();
                        ...
                        _a.label = 4;
                    case 4:
                        this.webContents.once("dom-ready", function () {
                            _this.webContents.send("change-theme");
                        });
                        return [2 /*return*/];
                }
            });
    ...
    MainWindow.prototype.onMaximize = function () {
        var restoreSize = [];
        if (!this.isMaximized()) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.showSplashWindow = void 0;
var electron_1 = __webpack_require__(/*! electron */ "./node_modules/electron/index.js");
var config_1 = __webpack_require__(/*! ../config */ "./main/config/index.ts");
/**
 ...
 * @returns
 */
function showSplashWindow(mainWindow) {
    return __awaiter(this, void 0, void 0, function () {
        var isProd, options, splash, url, port;
        return __generator(this, function (_a) {
            isProd = "development" === "production";
            options = config_1.config.splashWindow.get();
            splash = new electron_1.BrowserWindow(options);
            url = "";
            if (isProd) {
                url = "app://./splash.html";
            }
                ...
                port = process.argv[2];
                url = "http://localhost:".concat(port, "/splash");
            }
            splash.loadURL(url);
            splash.center();
            splash.on("close", function () { return mainWindow.show(); });
            splash.close();
            return [2 /*return*/, splash];
        });
    });
}
exports.showSplashWindow = showSplashWindow;
