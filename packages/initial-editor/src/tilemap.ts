...
export default class Tilemap extends Component {
     ...
     */
    private _semiTransparentOpacity = 1.0;
    ...
    public takeScreenshot() {
        ...
        app.renderer.extract.canvas(app.stage).toBlob(
    ...
    public clear(): Tilemap {
        if (!this._layerContainer) return this;
        if (!this._layerContainer.children) return this;
